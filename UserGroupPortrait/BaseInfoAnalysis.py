...
class BaseAnalysis():
    ...
    def get_sex(self):
        try:
            ...
            data_sex_index = list(data_sex.index)
            dicts = {}
            result = {}
            if len(set(data_sex_index)) > 1:
                dicts['男'] = data_sex[1]
                dicts['女'] = data_sex[0]
                result['MainClass'] = {'性别_MainClass_Equal': {'ClassifyValue': dicts}}
                result['MainClassTotal'] = {'性别汇总': self.data.sex.count()}
                return result
            elif len(set(data_sex_index)) == 1:
                if 1 in data_sex_index:
                    dicts['男'] = data_sex[1]
                    dicts['女'] = 0
                    result['MainClass'] = {'性别_MainClass_Equal': {'ClassifyValue': dicts}}
                    result['MainClassTotal'] = {'性别汇总': self.data.sex.count()}
                    return result
                elif 0 in data_sex_index:
                    dicts['男'] = 0
                    dicts['女'] = data_sex[0]
                    result['MainClass'] = {'性别_MainClass_Equal': {'ClassifyValue': dicts}}
                    result['MainClassTotal'] = {'性别汇总': self.data.sex.count()}
    ...
    def get_brand_model(self):
        try:
                        ...
                        if j.upper() not in list(map(lambda x: x.upper(), data_model_dict_new.keys())):
                            ...
                            for keys_new in data_model_dict_new.keys():
                                if keys_new.upper() == j.upper():
                                    ...
                                    pass
                    dict_new[i] = {'ClassifyValue': data_model_dict_new,
                                   'ChildClassTotal': len(self.data[self.data.brand == i])}
            ...
            print('brand_model original data error!')
            return {}
    ...
    def get_listing_date(self):
        try:
            ...
            print('listing_data original data error!')
            return {}
    ...
    def get_listing_price(self):
        try:
            ...
            dicts['500-1000'] = data_listing_price[
                (data_listing_price.index >= 500) & (data_listing_price.index < 1000)].sum()
            dicts['1000-1500'] = data_listing_price[
                (data_listing_price.index >= 1000) & (data_listing_price.index < 1500)].sum()
            dicts['1500-2000'] = data_listing_price[
                (data_listing_price.index >= 1500) & (data_listing_price.index < 2000)].sum()
            dicts['2000-2500'] = data_listing_price[
                (data_listing_price.index >= 2000) & (data_listing_price.index < 2500)].sum()
            dicts['2500-3000'] = data_listing_price[
                (data_listing_price.index >= 2500) & (data_listing_price.index < 3000)].sum()
            dicts['3000-3500'] = data_listing_price[
                (data_listing_price.index >= 3000) & (data_listing_price.index < 3500)].sum()
            dicts['3500-4000'] = data_listing_price[
                (data_listing_price.index >= 3500) & (data_listing_price.index < 4000)].sum()
            dicts['4000-4500'] = data_listing_price[
                (data_listing_price.index >= 4000) & (data_listing_price.index < 4500)].sum()
            dicts['4500-5000'] = data_listing_price[
                (data_listing_price.index >= 4500) & (data_listing_price.index < 5000)].sum()
            dicts['5000-5500'] = data_listing_price[
                (data_listing_price.index >= 5000) & (data_listing_price.index < 5500)].sum()
            dicts['5500-6000'] = data_listing_price[
                (data_listing_price.index >= 5500) & (data_listing_price.index < 6000)].sum()
            dicts['6000-6500'] = data_listing_price[
                (data_listing_price.index >= 6000) & (data_listing_price.index < 6500)].sum()
            dicts['6500-7000'] = data_listing_price[
                (data_listing_price.index >= 6500) & (data_listing_price.index < 7000)].sum()
            dicts['7000-7500'] = data_listing_price[
                (data_listing_price.index >= 7000) & (data_listing_price.index < 7500)].sum()
            dicts['7500-8000'] = data_listing_price[
                (data_listing_price.index >= 7500) & (data_listing_price.index < 8000)].sum()
            dicts['8000-8500'] = data_listing_price[
                (data_listing_price.index >= 8000) & (data_listing_price.index < 8500)].sum()
            dicts['8500-9000'] = data_listing_price[
                (data_listing_price.index >= 8500) & (data_listing_price.index < 9000)].sum()
            dicts['9000-9500'] = data_listing_price[
                (data_listing_price.index >= 9000) & (data_listing_price.index < 9500)].sum()
            ...
            print('listing_price original data error!')
            return {}
    ...
    def get_netlong(self):
        try:
            ...
            print('netlong origin data is error!')
            return {}
    ...
    def get_card_type(self):
        try:
            ...
            print('data_card_type original data error!')
            return {}
    ...
    def get_star_type(self):
        try:
            ...
            dicts['0星用户'] = data_star_type[
                (data_star_type.index == '0') | (data_star_type.index == '-999') | (data_star_type.index == '未评级')].sum()
            ...
            print('data_star_typr original data error!')
            return {}
    ...
    def get_city(self):
        try:
            ...
            print('city original data error!')
            return {}
    ...
    def get_arpu(self):
        try:
            ...
            print('ARPU original data error!')
            return {}
    ...
    def get_out_prdct_fee(self):
        try:
            ...
            dicts['100-150'] = data_out_prdct_fee[
                (data_out_prdct_fee.index >= 100) & (data_out_prdct_fee.index < 150)].sum()
            dicts['150-200'] = data_out_prdct_fee[
                (data_out_prdct_fee.index >= 150) & (data_out_prdct_fee.index < 200)].sum()
            dicts['200-300'] = data_out_prdct_fee[
                (data_out_prdct_fee.index >= 200) & (data_out_prdct_fee.index < 300)].sum()
            ...
            print('out_prdct_fee original data error!')
            return {}
    ...
    def get_myfee(self):
        try:
            ...
            print('myth_fee original data error!')
            return {}
    ...
    def get_point_fee(self):
        try:
            ...
            print('point_fee original data error!')
            return {}
    ...
    def get_credit_limit(self):
        try:
            ...
            dicts['10000-30000'] = data_credit_limit[
                (data_credit_limit.index >= 10000) & (data_credit_limit.index < 30000)].sum()
            dicts['30000-50000'] = data_credit_limit[
                (data_credit_limit.index >= 30000) & (data_credit_limit.index < 50000)].sum()
            ...
            print('credit_limit original data error!')
            return {}
    ...
    def get_credit_payment_avg(self):
        try:
            ...
            dicts['0-10000'] = data_credit_payment_avg[
                (data_credit_payment_avg.index > 0) & (data_credit_payment_avg.index < 10000)].sum()
            dicts['10000-30000'] = data_credit_payment_avg[
                (data_credit_payment_avg.index >= 10000) & (data_credit_payment_avg.index < 30000)].sum()
            dicts['30000-50000'] = data_credit_payment_avg[
                (data_credit_payment_avg.index >= 30000) & (data_credit_payment_avg.index < 50000)].sum()
            ...
            print('credit_payment_avg original data error!')
            return {}
    ...
    def get_location(self):
        try:
            ...
            print('location original data error!')
            return {}
